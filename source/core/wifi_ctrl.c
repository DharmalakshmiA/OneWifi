...
{
    wifi_mgr_t *g_wifi_mgr = get_wifimgr_obj();
    wifi_util_error_print(WIFI_CTRL, "%s:%d Rogue-AP-Enable:%d Rogue-AP-freq:%d\n", __func__, __LINE__, g_wifi_mgr->global_config.rogue_config.rogue_ap_enable, g_wifi_mgr->global_config.rogue_config.rogue_ap_freq); 
#ifdef ONEWIFI_ANALYTICS_APP_SUPPORT
...
#endif
    if (g_wifi_mgr->global_config.rogue_config.rogue_ap_enable) {
        scheduler_add_timer_task(ctrl->sched, FALSE, NULL, rogueap_timer_handler, NULL, (g_wifi_mgr->global_config.rogue_config.rogue_ap_freq * 60 * 1000), 0, FALSE);        
